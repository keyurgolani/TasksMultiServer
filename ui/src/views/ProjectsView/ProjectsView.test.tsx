...
// Wrapper component with DataServiceProvider, RefreshProvider, ToastProvider and Router
    ...
    <BrowserRouter>
      <ToastProvider>
        <DataServiceProvider service={service}>
          <RefreshProvider>{ui}</RefreshProvider>
        </DataServiceProvider>
      </ToastProvider>
    </BrowserRouter>
  );
...
describe("ProjectsView", () => {
  ...
  describe("search functionality - Requirements: 3.3", () => {
    it("filters projects by search query", async () => {
      ...
      // Wait for debounce and filter - use getAllByText since there may be multiple renders during transition
      await waitFor(() => {
