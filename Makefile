.PHONY: install test test-integration test-all build clean format lint typecheck audit docker-up docker-down
...
all: clean format audit lint typecheck test build
